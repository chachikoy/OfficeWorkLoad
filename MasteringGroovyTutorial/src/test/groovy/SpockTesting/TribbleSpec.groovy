...
import otherClass.Klingon
import otherClass.Tribble
import otherClass.Vulcan
...
class tribbleSpec extends Specification{
    ...
    def "number of tribbles in storage compartment"(){
        ...
        //implementation
        and: "new generation every 12 hrs over a period of three days"
        //implementation
